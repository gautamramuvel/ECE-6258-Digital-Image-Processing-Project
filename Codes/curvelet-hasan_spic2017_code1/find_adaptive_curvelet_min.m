function [scale_locations,nbangles,PSNR]=find_adaptive_curvelet_min(img,noisy_img,sigma,measure)
%Funcctio to find the optimal curvelet tiling by denoising:
% Input arguments-
...
function [ finaloutput,PSNR] = findoptimalangular(measure,noisy_img,img,scale_locations,sigma)
...
for i=1:numvariables            
       if i<=halfvariables-1              
           for testingangle=sequence
               ...
               PSNR=denoise(measure,noisy_img,img,scale_locations,testingnbangles,sigma);
               curroutput=PSNR;                                                                                                                                                                                                 
